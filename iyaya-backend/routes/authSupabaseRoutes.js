...
const loadController = (name) => {
  try {
    ...
    if (name === 'authSupabase') {
      console.error('🚨 Critical: Supabase Auth controller is required for the application to function');
      console.log('Attempting to locate auth controller...');

      // Try common alternative names
      const alternatives = ['auth', 'authController', 'AuthController', 'userAuth'];
